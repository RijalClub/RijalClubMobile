  ...
  return (
    <SafeAreaView>
      <Modal visible={isVisible} transparent={true} onRequestClose={hideModal}>
        ...
        <StripeProvider
          publishableKey='pk_test_51OSoUmJKRTIl2Np17B7pJgBN9x1Px8siZIVSzL3G75PJ1sB3HrPQZFpDE9aMQwc8wAQNk1oUA7bzwpCVwWtVEXfP00qpTGKrNN'
          merchantIdentifier="merchant.com.RijalClubMobile">
          <CheckoutModalScreen
            eventDetails={event}
